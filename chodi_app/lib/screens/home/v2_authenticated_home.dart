...
class v2_AuthenticatedHomeScreen extends StatefulWidget {
  @override
  _v2_AuthenticatedHomeScreenState createState() => _v2_AuthenticatedHomeScreenState();
}

class _v2_AuthenticatedHomeScreenState extends State<v2_AuthenticatedHomeScreen> {
  bool loading = false;
  List<Color> selectedColors = [Colors.yellow, Colors.orange[400], Colors.red, Colors.blue, Colors.green];
...
//        ),
              ...
              title: Center(
                child: RichText(
                    text: new TextSpan(style: new TextStyle(fontSize: 24.0, fontWeight: FontWeight.w800, letterSpacing: 1.0), children: <TextSpan>[
